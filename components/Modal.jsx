              ...
              <div>
                ...
                <div className="mt-5 sm:mt-6">
                  <button
                    ...
                    className="inline-flex justify-center rounded-md border border-transparent shadow-sm px-4 py-2 w-full bg-red-600 text-base text-white font-medium hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500 sm:text-sm disabled:bg-gray-300 disabled:cursor-not-allowed hover:disabled:bg-gray-400"
                  >
                    {loadig ? "Uploading..." : "Upload Post"}
                  </button>
                </div>
              </div>
            </div>
